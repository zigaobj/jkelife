...
/*
	u8		CmdListNum;													//´ý´¦ÀíµÄÃüÁî¸öÊý
	u8		CmdCurrentList;
	u8		CmdListFlag[CMD_LISTLMT];						//¼ÇÂ¼ÃüÁî´¦Àí»º³åÊ¹ÓÃÇé¿ö£¬0±íÊ¾¶ÔÓ¦Ë÷Òý¿Õ£¬1±íÊ¾Ë÷ÒýÄÚÓÐ´ý´¦ÀíµÄÃüÁî
 	CMD_BODY_TypeDef * pCmd_Body_Current;							//Ö¸Ïò´ý´¦ÀíµÄÃüÁî´¦Àí»º³åÇø
	CMD_BODY_TypeDef	 Cmd_Body[CMD_LISTLMT];	//ÃüÁî´¦Àí»º³å¿Õ¼ä
	CMD_BODY_TypeDef * pReplyBuf;							//Ó¦´ð»º³åÇø	
*/
